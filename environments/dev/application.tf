module "application" {
    ...
    alb_target_group_for_blue_arn = module.network.alb_target_group_for_blue_arn
    alb_target_group_for_green_arn = module.network.alb_target_group_for_green_arn
